    ...
    form.addEventListener('submit', (event) => {
        ...
        window.PPPostalCoverage.check(input.value).then((resultado) => {
            ...
            if (!resultado.cubierto) {
                resultEl.className = 'postal-bar__result postal-bar__result--blocked';
                resultEl.textContent = 'La entrega a domicilio solo aplica dentro del municipio de La Paz, B.C.S. Puedes consultar opciones de recolección en tienda (Mariano Abasolo 3114, Plaza Susana) o llamarnos para cotizaciones de mayoreo.';
                return;
            }
